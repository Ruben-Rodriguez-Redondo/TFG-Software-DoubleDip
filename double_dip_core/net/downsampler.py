...
from double_dip_core.utils.image_io import pil_to_np, crop_image, np_to_pil
from double_dip_core.utils.imresize import imresize


class Downsampler(nn.Module):
    """
    Implements a convolution-based downsampler using different kernel types (Lanczos, Gaussian, Box).
    ...
    def forward(self, input):
        """
        Applies the downsampling process to an input image.
        """
...
def get_kernel(factor, kernel_type, phase, kernel_width, support=None, sigma=None):
    """
    Generates a filter kernel of a specified type (Lanczos, Gaussian, or Box) for image downsampling.
    """
