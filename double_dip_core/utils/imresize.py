...
def imresize(im, scale_factor=None, output_shape=None, kernel=None, antialiasing=True, kernel_shift_flag=False):
    """
    Resizes an image using different interpolation methods with optional antialiasing.
    """
...
def resize_along_dim(im, dim, weights, field_of_view):
    """
    Resizes an image along a specific dimension using weighted averaging.
    """
...
def numeric_kernel(im, kernel, scale_factor, output_shape, kernel_shift_flag):
    """
    Applies a numeric kernel for convolution-based downscaling
    """
...
def kernel_shift(kernel, sf):
    """
    Adjusts a kernel's center of mass to align with the expected degradation model.
    """
...
def np_imresize(im, scale_factor=None, output_shape=None, kernel=None, antialiasing=True, kernel_shift_flag=False):
    """
    Resizes an image using NumPy with multiple interpolation options.
    """
